...
namespace FilterPaths
{
    public partial class frmAbout : Form
    {
        ...
        private void InitializeUI()
        {
            ...
            lblAuthorInfo.Text = "박햇님 (Haennim.Park@gmail.com)";
            ...
            sb.AppendLine("Haennim Park (haennim.park@gmail.com) wrote this software. As long as you retain this notice you can do whatever you want with this stuff. If we meet some day, and you think this stuff is worth it, you can buy me a beer in return.");
            sb.AppendLine();
